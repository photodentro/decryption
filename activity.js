...
function initLevel(newLevel) {
  ...
  words = [
    ['ΑΡΝΙ', 'ΒΟΔΙ', 'ΒΟΔΙ', 'ΓΑΤΑ', 'ΓΚΡΙ', 'ΔΡΥΣ', 'ΕΛΙΑ', 'ΙΤΙΑ', 'ΚΑΦΕ',
      'ΛΑΜΑ', 'ΜΗΛΟ', 'ΜΠΛΕ', 'ΜΥΓΑ', 'ΡΟΔΙ', 'ΡΥΖΙ', 'ΣΥΚΟ', 'ΦΙΔΙ', 'ΧΕΛΙ',
      'ΧΗΝΑ', 'ΨΑΡΙ'],
    ['ΑΕΤΟΣ', 'ΑΛΟΓΟ', 'ΑΣΒΟΣ', 'ΑΣΗΜΙ', 'ΑΣΠΡΟ', 'ΔΑΦΝΗ', 'ΕΛΑΤΟ', 'ΕΛΑΦΙ',
      'ΕΛΑΦΙ', 'ΖΕΒΡΑ', 'ΙΩΔΕΣ', 'ΚΙΤΡΟ', 'ΚΟΑΛΑ', 'ΚΥΑΝΟ', 'ΛΑΓΟΣ', 'ΛΕΥΚΑ',
      'ΛΥΚΟΣ', 'ΛΩΤΟΣ', 'ΜΑΥΡΟ', 'ΜΟΥΡΟ', 'ΠΑΝΤΑ', 'ΠΑΠΙΑ', 'ΠΕΥΚΟ', 'ΠΙΚΕΑ',
      'ΥΑΙΝΑ', 'ΦΙΚΟΣ', 'ΦΩΚΙΑ', 'ΧΡΥΣΟ'],
    ['ΑΖΑΛΕΑ', 'ΑΚΑΚΙΑ', 'ΑΛΕΠΟΥ', 'ΑΝΑΝΑΣ', 'ΑΡΑΧΝΗ', 'ΑΧΙΝΟΣ', 'ΑΧΛΑΔΙ',
      'ΒΟΥΡΛΑ', 'ΓΑΖΕΛΑ', 'ΓΕΡΑΚΙ', 'ΓΕΡΑΝΙ', 'ΓΛΑΡΟΣ', 'ΔΕΝΔΡΟ', 'ΚΑΜΗΛΑ',
      'ΚΑΡΥΔΑ', 'ΚΕΔΡΟΣ', 'ΚΕΡΑΣΙ', 'ΚΟΜΠΡΑ', 'ΚΟΡΑΚΙ', 'ΚΡΑΝΙΑ', 'ΚΡΙΑΡΙ',
      'ΚΡΙΝΟΣ', 'ΚΡΙΝΟΣ', 'ΚΡΟΚΟΣ', 'ΚΥΔΩΝΙ', 'ΚΥΚΝΟΣ', 'ΛΕΜΟΝΙ', 'ΛΟΥΙΖΑ',
      'ΛΥΓΚΑΣ', 'ΜΑΝΓΚΟ', 'ΜΟΛΟΧΑ', 'ΜΟΥΡΙΑ', 'ΝΤΑΛΙΑ', 'ΠΑΓΩΝΙ', 'ΠΑΝΣΕΣ',
      'ΠΑΤΑΤΑ', 'ΠΕΠΟΝΙ', 'ΡΙΓΑΝΗ', 'ΣΚΝΙΠΑ', 'ΣΚΥΛΟΣ', 'ΣΠΙΝΟΣ', 'ΣΦΗΓΚΑ',
      'ΤΑΥΡΟΣ', 'ΤΙΓΡΗΣ', 'ΧΕΛΩΝΑ'],
    ['ΑΓΕΛΑΔΑ', 'ΑΜΠΕΛΙΑ', 'ΑΡΚΟΥΔΑ', 'ΑΣΤΑΚΟΣ', 'ΑΧΛΑΔΙΑ', 'ΒΙΟΛΕΤΑ',
      'ΒΙΣΩΝΑΣ', 'ΒΥΣΣΙΝΟ', 'ΓΕΡΑΝΟΣ', 'ΓΙΑΣΕΜΙ', 'ΓΟΡΙΛΑΣ', 'ΔΕΛΦΙΝΙ',
      'ΕΡΩΔΙΟΣ', 'ΚΑΒΟΥΡΙ', 'ΚΑΜΕΛΙΑ', 'ΚΑΡΥΔΙΑ', 'ΚΑΣΤΑΝΟ', 'ΚΑΤΣΙΚΑ',
      'ΚΕΡΑΣΙΑ', 'ΚΙΤΡΙΝΟ', 'ΚΟΚΚΙΝΟ', 'ΚΟΡΑΚΑΣ', 'ΚΟΥΝΑΒΙ', 'ΚΟΥΝΕΛΙ',
      'ΛΕΒΑΝΤΑ', 'ΛΟΥΛΑΚΙ', 'ΜΑΝΟΛΙΑ', 'ΜΕΔΟΥΣΑ', 'ΜΕΛΙΣΣΑ', 'ΜΕΝΕΞΕΣ',
      'ΜΠΑΝΑΝΑ', 'ΝΤΟΜΑΤΑ', 'ΟΡΧΙΔΕΑ', 'ΠΑΙΩΝΙΑ', 'ΠΕΡΔΙΚΑ', 'ΠΙΘΗΚΟΣ',
      'ΠΟΝΤΙΚΙ', 'ΠΟΡΦΥΡΑ', 'ΠΡΑΣΙΝΟ', 'ΠΡΟΒΑΤΟ', 'ΣΤΑΦΥΛΙ', 'ΣΤΡΕΙΔΙ',
      'ΤΣΑΚΑΛΙ', 'ΦΑΛΑΙΝΑ', 'ΦΑΣΟΛΙΑ', 'ΦΡΑΟΥΛΑ'],
    ['ΑΝΘΡΩΠΟΣ', 'ΑΝΤΙΛΟΠΗ', 'ΑΣΤΕΡΙΑΣ', 'ΒΑΤΡΑΧΟΣ', 'ΒΕΡΙΚΟΚΟ', 'ΒΟΥΒΑΛΟΣ',
      'ΓΑΙΔΟΥΡΙ', 'ΓΑΡΔΕΝΙΑ', 'ΓΕΒΡΙΛΟΣ', 'ΓΟΥΡΟΥΝΙ', 'ΕΝΥΔΡΙΔΑ', 'ΙΝΔΟΣΥΚΗ',
      'ΚΑΡΠΟΥΖΙ', 'ΚΑΣΤΟΡΑΣ', 'ΚΟΥΝΟΥΠΙ', 'ΚΟΥΡΟΥΝΑ', 'ΛΙΟΝΤΑΡΙ', 'ΜΠΑΝΑΝΙΑ',
      'ΜΥΡΜΗΓΚΙ', 'ΜΥΡΤΙΛΟΣ', 'ΠΕΤΟΥΝΙΑ', 'ΠΛΑΤΑΝΟΣ', 'ΠΟΝΤΙΚΟΣ', 'ΡΟΔΑΚΙΝΟ',
      'ΣΚΙΟΥΡΟΣ', 'ΣΠΑΡΑΓΓΙ', 'ΣΦΕΝΔΑΜΙ', 'ΦΟΙΝΙΚΑΣ', 'ΧΕΛΙΔΟΝΙ'],
